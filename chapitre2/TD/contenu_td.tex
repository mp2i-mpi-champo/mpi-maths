...
\textbf{1. (b)} La fonction $g$ étant strictement décroissante et continue sur $\mathbb{R}$, elle induit une bijection de $\mathbb{R}$ sur $g(\mathbb{R})=\mathbb{R}$.
...
\textbf{2.} Soit $h$ une fonction continue sur $\mathbb{R}$ telle que $\forall x\in\mathbb{R}, h(x)=h(\arctan x)$.
...
% --- Correction 2 ---
\begin{correction}{2}
\textbf{a)} On pose $c$ la constante telle que $c=ac+b$, c'est-à-dire $c=\frac{b}{1-a}$.
Alors $v_{n}=u_{n}-c$ est géométrique de raison $a$.
Donc pour tout $n$, $v_{n}=a^{n}v_{0}$ donc $u_{n}=c+a^{n}(u_{0}-c)$.

\textbf{b)} On note $u_{n}$ le capital restant dû au bout de $n$ mois.
...
% --- Correction 6 ---
\begin{correction}{6}
\textbf{1.} Par hypothèse, $\exists N_{0}\in\mathbb{N}, \forall n\ge N_{0}, v_{n}\ne0$.
...
\textbf{2.} Au voisinage de $+\infty$, $\sinh(\frac{1}{n})=\frac{1}{n}+\frac{1}{6n^{3}}+o(\frac{1}{n^{3}})$ et $\tan\frac{1}{n}=\frac{1}{n}+\frac{1}{3n^{3}}+o(\frac{1}{n^{3}})$.
...
% --- Correction 7 ---
\begin{correction}{7}
\textbf{1)} On étudie $f_{n}$ et on lui applique le théorème de la bijection, on trouve $x_{n}>1$.
\textbf{2)} La stricte croissance de $f_{n}$ montre que $x_{n+1}-x_{n}$ est du même signe que $f_{n}(x_{n+1})-f_{n}(x_{n})=f_{n}(x_{n+1})$ car $f_n(x_n)=0$.
...
\textbf{3)} On a $\ell\ge1$. Supposons par l'absurde que $\ell>1$. En passant à la limite $f_{n}(x_{n})=0$ on tombe sur une contradiction (termes tendant vers l'infini), donc $\ell=1$.
\textbf{4)} Le résultat sur $\alpha$ se montre par le théorème de la bijection.
