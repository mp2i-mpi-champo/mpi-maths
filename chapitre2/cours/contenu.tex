...
On prendra $(E, N)$ un espace vectoriel normé sur $\K$.
...
\subsection{Théorèmes liés à l'ordre dans $\R$}
...
\begin{theorement}{Signe d'une suite à partir d'un rang avec la limite}{}
...
\begin{theorement}{de la limite monotone}{}
...
\begin{propositionnt}{Nature de l'ensemble des suites récurrentes linéaires d'ordre 2}{}
    Soient $a, b \in \C$.  
...
\begin{theorement}{Somme de limites}{}
...
\begin{theorement}{Produit de limites}{}
    Soient $(u_n)_{n \in \N}$ et $(v_n)_{n \in \N} \in \R^{\N}$ telles que
...
\begin{definitionnt}{Convergence}{}
...
\subsection{Complément hors programme (suites de Cauchy)}
